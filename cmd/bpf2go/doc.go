...
//    //go:generate go run github.com/DataDog/ebpf/cmd/bpf2go foo path/to/src.c -- -I/path/to/include
...
//    //go:generate go run github.com/DataDog/ebpf/cmd/bpf2go -cflags "$BPF_CFLAGS" foo path/to/src.c
...
// fully working example at https://github.com/DataDog/ebpf/blob/master/cmd/bpf2go/example_test.go.
package main
