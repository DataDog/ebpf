...
import (
	...
	ringbuffer "github.com/DataDog/ebpf/perf"
	goperf "github.com/elastic/go-perf"
	"golang.org/x/sys/unix"
)

//go:generate go run github.com/DataDog/ebpf/cmd/bpf2go -cc clang-11 UProbeExample ./bpf/uprobe_example.c -- -I../headers -O2
